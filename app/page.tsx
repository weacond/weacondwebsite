  ...
  return (
    <Layout>
      <div className="space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-2">我们的理念</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-2">关于 Weacond</h2>
          <p>
            Weacond 是一个年轻的金融理念项目，由对市场理性思维充满热情的团队创建。我们的目标是帮助个人投资者建立稳定、系统化的财富思维。
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-2">联系</h2>
          <p>邮箱：weacond@gmail.com</p>
