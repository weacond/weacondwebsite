...
export default function Home() {
  ...
  const t = {
    zh: {
      ...
      philosophy:
        "投资应基于数据与逻辑，而非情绪。金融教育是每个人必备的技能。自动化与智能化是未来的趋势。",
      aboutTitle: "关于 Weacond",
      about:
        "Weacond 是一个以市场理性为核心的项目，致力于帮助个人投资者建立稳定、系统化的财富思维。",
      contact: "联系: weacond@gmail.com",
      disclaimer:
        "免责声明：本站内容仅供教育与研究用途，不构成任何投资建议。",
    },
    en: {
      heroTitle: "Make investing easy, convenient, and stable",
      heroSubtitle:
        "Weacond — focused on rational investment education & intelligent systems",
      cta: "Explore Ebooks",
      philosophyTitle: "Our Philosophy",
      philosophy:
        "Investing should be based on data and logic, not emotion. Financial education is a skill everyone needs. Automation and intelligence are the future.",
      aboutTitle: "About Weacond",
      about:
        "Weacond is a project centered on market rationality, helping individuals build stable systematic wealth thinking.",
      contact: "Contact: weacond@gmail.com",
      disclaimer:
        "Disclaimer: Content is for educational and research purposes only. Not financial advice.",
    },
  }[currentLang] || {
    heroTitle: "让投资变得轻松、便捷、稳健",
    heroSubtitle: "Weacond — 专注于理性投资教育与智能系统",
