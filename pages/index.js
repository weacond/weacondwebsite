  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <header className="bg-gradient-to-r from-primary to-secondary text-white h-screen flex flex-col justify-center items-center text-center px-6">
        ...
        <a href="/ebooks" className="mt-6 px-8 py-4 bg-white text-primary font-bold rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition transform">探索电子书</a>
      </header>
